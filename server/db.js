    ...
    if (parseInt(res.rows[0].count) === 0) {
      ...
      for (const r of defaultRooms) {
        await pool.query(
          ...
          [r.name, r.desc, r.price, r.capacity, JSON.stringify(r.amenities), JSON.stringify(['https://images.unsplash.com/photo-1631049307264-da0ec9d70304?q=80&w=1000&auto=format&fit=crop'])]
        );
      }
    }
